...
const clientNav: NavItem[] = [
  ...
  { label: "Press Release Builder", href: "/client/press-release-builder", icon: PenLine },
  { label: "Media Interview Q&A", href: "/client/media-interview-qna", icon: Mic },
  { label: "Activity Proposals", href: "/client/activity-proposal-builder", icon: CalendarPlus },
